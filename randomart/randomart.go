...
// copied from https://github.com/calmh/randomart and modified for own purposes
package randomart
...
func (board Board) String() string {
	...
	buf.WriteString("\033[92m\033[41m") // print text with red background and green foreground
